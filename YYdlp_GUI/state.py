...
T_REACTIVESTATE = TypeVar("T_REACTIVESTATE")
...
class State(Generic[T_STATE], IState):
    """
    ...
    [ForestMountain1234's Qiita](https://qiita.com/ForestMountain1234/)"""  # noqa: E501,W291

    def __init__(self, value: T_STATE | None = None) -> None:
        self.__value = value
        self.__observers: list[Callable[[T_STATE | None], None]] = []

    def get(self) -> T_STATE | None:
        return self.__value

    def set(self, new_value: T_STATE):
...
class ReactiveState(Generic[T_REACTIVESTATE], IState):
    ...
    def __init__(
        self, formula: Callable[[], T_REACTIVESTATE], reliance_states: list[IState]
    ):
        ...
        self.__observers: list[Callable[[T_REACTIVESTATE | None], None]] = []
    ...
    def get(self) -> T_REACTIVESTATE | None:
